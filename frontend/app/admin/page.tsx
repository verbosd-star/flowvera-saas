            ...
            <div className="bg-white dark:bg-zinc-900 rounded-lg border border-zinc-200 dark:border-zinc-800 p-6">
              ...
              <div className="space-y-3">
                ...
                >
                  <span className="text-2xl">📈</span>
                  <div>
                    <div className="font-medium text-zinc-900 dark:text-white">View Analytics</div>
                    <div className="text-sm text-zinc-600 dark:text-zinc-400">Monitor metrics and growth</div>
                  </div>
                </button>
                <button
                ...
                >
                  <span className="text-2xl">📋</span>
                  <div>
                    <div className="font-medium text-zinc-900 dark:text-white">Activity Logs</div>
                    <div className="text-sm text-zinc-600 dark:text-zinc-400">Monitor system activities</div>
                  </div>
                </button>
                <button
                ...
                >
                  <span className="text-2xl">🎭</span>
                  <div>
                    <div className="font-medium text-zinc-900 dark:text-white">Custom Roles</div>
                    <div className="text-sm text-zinc-600 dark:text-zinc-400">Manage roles and permissions</div>
                  </div>
                </button>
                <button
